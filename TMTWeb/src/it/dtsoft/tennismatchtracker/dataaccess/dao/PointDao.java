...
import java.util.List;
 ...
 /**
  * Point Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Point object instances. 
  */
...
public class PointDao {
     ...
     * clone() method in it!
     */
    public Point createValueObject() {
          return new Point();
    }
     ...
     */
    public Point getObject(Connection conn, int pointId) throws NotFoundException, SQLException {

          Point valueObject = createValueObject();
          valueObject.setPointId(pointId);
    ...
    public void load(Connection conn, Point valueObject) throws NotFoundException, SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getPointId()); 
     ...
     */
    public synchronized void create(Connection conn, Point valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setInt(2, valueObject.getPlayerId()); 
          ...
          */
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPointId((int)result.getLong(1));
     ...
     */
    public List searchMatching(Connection conn, Point valueObject) throws SQLException {
          ...
          if (valueObject.getPointId() != 0) {
              ...
              sql.append("AND pointId = ").append(valueObject.getPointId()).append(" ");
          }
          ...
          if (valueObject.getPlayerId() != 0) {
              if (first) { first = false; }
              sql.append("AND playerId = ").append(valueObject.getPlayerId()).append(" ");
          }

          if (valueObject.getPointType() != null) {
              if (first) { first = false; }
              sql.append("AND pointType LIKE '").append(valueObject.getPointType()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Point valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPointId(result.getInt("pointId")); 
                   valueObject.setMatchId(result.getInt("matchId")); 
                   valueObject.setPlayerId(result.getInt("playerId")); 
                   ...
                   valueObject.setPointLiteral(result.getString("pointLiteral")); 
                    ...
                    throw new NotFoundException("Point Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   Point temp = createValueObject();

                   temp.setPointId(result.getInt("pointId")); 
                   temp.setMatchId(result.getInt("matchId")); 
                   temp.setPlayerId(result.getInt("playerId")); 
