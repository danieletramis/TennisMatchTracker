...
import java.util.List;
 ...
 /**
  * Player Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Player object instances. 
  */
...
public class PlayerDao {
     ...
     */
    public Player getObject(Connection conn, int playerId) throws NotFoundException, SQLException {

          Player valueObject = createValueObject();
          valueObject.setPlayerId(playerId);
    ...
    public void load(Connection conn, Player valueObject) throws NotFoundException, SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getPlayerId()); 
          ...
          */
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPlayerId((int)result.getLong(1));
    ...
    public List searchMatching(Connection conn, Player valueObject) throws SQLException {
          ...
          sql.append("ORDER BY playerId ASC ");
